...
def chatbot_response(user_message: str) -> str:
    ...
    if user_message in ["hi", "hello", "hey", "start"]:
        return "👋 Hello! Welcome to PTC-Dumaguete, How can I help you today?"

    elif "Create account for TESDA Online Program" in user_message or user_message == "1":
    ...
    elif "scholarship" in user_message or user_message == "3":
        return "📞 Okay, Here are our courses offering, Driving NC II, Masonry NC II."
...
# --------------------------
st.set_page_config(page_title="Welcome to PTC-Dumaguete", page_icon="🤖", layout="wide")
